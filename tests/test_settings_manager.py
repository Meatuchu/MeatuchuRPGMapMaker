...
from MeatuchuRPGMapMaker.core_classes.settings import SettingsManager


mock_settings = {"default": {"window": {"width": 123, "height": 456}}}


@patch("MeatuchuRPGMapMaker.core_classes.settings.__settings_values__", mock_settings)
